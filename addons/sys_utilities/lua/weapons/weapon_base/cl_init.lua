...
function SWEP:PrintWeaponInfo( x, y, alpha )
	...
	if (self.InfoMarkup == nil ) then
		...
		if ( text_color ) then str = str .. title_color .. "</color>\t" .. text_color .. "HorizenRP" .. "</color>\n" end
		--if ( text_color ) then str = str .. title_color .. "Сайт:</color>\t" .. text_color .. "fp-gaming.ru" .. "</color>\n" end
