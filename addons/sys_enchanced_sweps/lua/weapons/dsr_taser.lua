...
SWEP.PrintName = "Электрошок" -- change the name
...
DarkRP.createAmmoType("stungun", {
	name = "Электро пластины",
	model = "models/sterling/enhanced_taser_ammobox.mdl",
	price = 800,
	amountGiven = 6,
	allowed = {TEAM_POLICE, TEAM_CHIEF, TEAM_FBI, TEAM_DIRECTOR, TEAM_FORCES, TEAM_MEDIC, TEAM_SNIPER, TEAM_HEAVY, TEAM_COMMANDER},
	category = "Прочее"
})
