...
SWEP.PrintName = "Metal Detector" -- change the name
...
function SWEP:PrimaryAttack()
	...
	timer.Simple( 1, function() 
        if( not IsValid( self ) or not IsValid( ent ) or not IsValid( self.Owner ) or self.Owner:GetActiveWeapon() != self.Weapon ) then return end 
